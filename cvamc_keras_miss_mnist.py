...
batch_size = 100
original_dim = 784
latent_dim = 30 # 隐变量取2维只是为了方便后面画图
...
x_mc1 = Input(shape=(28,28,))
mc1_x = Reshape((28,28,1))(x_mc1)
...
'''
mc1 = ResNet50(include_top=False, weights='imagenet', input_shape=(28, 28, 3))
mc1_x = mc1.output
mc1_x = Flatten()(mc1_x)
mc1_h = Dense(intermediate_dim, activation='relu')(mc1_x)
'''
...
# 建立模型
vae = Model(inputs=[x_mc1, x, y, class_y], outputs=[x_decoded_mean, yh])
...
mean_encoder = Model([x_mc1, x], z_plus_mean)
mean_encoder.save('miss_0_mnist/mean_encoder.h5')

var_encoder = Model([x_mc1, x], z_plus_log_var)
var_encoder.save('miss_0_mnist/var_encoder.h5')

decoder_input = Input(shape=(latent_dim,))
_h_decoded = decoder_h(decoder_input)
_x_decoded_mean = decoder_mean(_h_decoded)
generator = Model(decoder_input, _x_decoded_mean)
generator.save('miss_0_mnist/generator.h5')

mu = Model(y, yh)
mu.save('miss_0_mnist/y_encoder.h5')
